...
output "workload_storage_admins_group_names"{
  value =  values(oci_identity_group.workload_storage_admins_group)[*].name
}

output "workload_storage_users_group_names"{
  value = values(oci_identity_group.workload_storage_users_group)[*].name
}

output "workload_admins_group_names"{
  value =  values(oci_identity_group.workload_admins_group)[*].name
}

output "workload_users_group_names"{
  value = values(oci_identity_group.workload_users_group)[*].name
}
