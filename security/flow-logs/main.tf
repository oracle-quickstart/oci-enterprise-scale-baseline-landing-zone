...
resource "oci_identity_policy" "log_analytics_policy" {
  ...
  statements = [
    ...
    "allow service loganalytics to {LOAD_BALANCER_READ} in compartment ${var.security_compartment_name}",
    "allow service loganalytics to {BUCKET_READ} in compartment ${var.security_compartment_name}",
    "allow service loganalytics to read functions-family in compartment ${var.security_compartment_name}",
    "allow service loganalytics to read api-gateway-family in compartment ${var.security_compartment_name}y",
