...
variable "egress_security_rules_udp_options_destination_port_range_max" {
  description = "[Workload Security List] Egress UDP Destination Port Range Max"
  type        = number
}

variable "egress_security_rules_udp_options_destination_port_range_min" {
  description = "[Workload Security List] Egress UDP Destination Port Range Min"
  type        = number
}

variable "egress_security_rules_udp_options_source_port_range_max" {
  description = "[Workload Security List] Egress UDP Source Port Range Max"
  type        = number
}

variable "egress_security_rules_udp_options_source_port_range_min" {
  description = "[Workload Security List] Egress UDP Source Port Range Min"
  type        = number
}
...
variable "ingress_security_rules_udp_options_destination_port_range_max" {
  description = "[Workload Security List] Ingress UDP Destination Port Range Max"
  type        = number
}

variable "ingress_security_rules_udp_options_destination_port_range_min" {
  description = "[Workload Security List] Ingress UDP Destination Port Range Min"
  type        = number
}

variable "ingress_security_rules_udp_options_source_port_range_max" {
  description = "[Workload Security List] Ingress UDP Source Port Range Max"
  type        = number
}

variable "ingress_security_rules_udp_options_source_port_range_min" {
  description = "[Workload Security List] Ingress UDP Source Port Range Min"
  type        = number
}
